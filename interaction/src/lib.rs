...
pub use source::{
    GeneratedSource, GeneratorProvenance, INTERACTION_GENERATOR_RNG_NAMESPACE,
    INTERACTION_MATRIX_FORMAT, INTERACTION_MATRIX_LAYOUT, InMemorySource, InteractionGenerator,
    InteractionMatrix, InteractionProvenance, InteractionSource, InteractionSourceError,
    InteractionSourceKind, JsonInteractionSource,
};
